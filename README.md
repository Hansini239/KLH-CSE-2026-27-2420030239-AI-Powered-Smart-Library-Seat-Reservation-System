...
* Protection against unauthorized reservations.
...
| Activity          | Tool                 |
| ----------------- | -------------------- |
| SDLC / Flowcharts | Draw.io, Lucidchart  |
| Agile / Scrum     | Jira, Trello         |
| User Stories      | Jira, Trello         |
| Product Backlog   | Jira, Trello         |
| Backlog Grooming  | Jira                 |
| Estimation        | Jira, Planning Poker |
...
> As a student, I want to view available library seats so that I can select a suitable seat.

### Reservation

> As a student, I want to reserve a seat for a specific time slot so that I can study without searching for an available seat.

### Recommendation

> As a student, I want the system to recommend suitable seats and time slots so that I can make a better reservation.

### Administrator

> As an administrator, I want to monitor seat occupancy so that I can efficiently manage library resources.

### Demand Prediction

> As an administrator, I want to predict future seat demand so that I can prepare for peak usage periods.
...
* Face recognition-based occupancy verification.
* IoT-enabled smart seats.
...
* Automatic cancellation of no-show reservations.
...
The project can therefore be developed as a complete **Data Science + AI + Web Application** project.
...
Future versions will integrate the AI prediction module, recommendation system, and real-time occupancy monitoring.
